...
var bottomTextX =  (width - labelArea)/4 + labelArea;
...
xText.append("text")
    ...
    .text("Average Population in Poverty (%)");
...
yText .append("text")
    ...
    .text("Average Number of Smokers (%)");
...
yText .append("text")
    ...
    .attr("data-axis", "y")
    .attr("class", "aText inactive y")
    .text("Ave Population Lacking Healthcare (%)");
   ...
   var toolTip = d3.tip()
    ...
    allCircles.append("circle")
        ...
        allCircles
          ...
          // Set on click function on dynamic graph
              ...
              if (self.classed("inactive")) {
                ...
                if (axis === "x") {
                 ...
                 // Update Y axis selection 
                  ...
                  // change class of active and clicked labels
                  labelUpdate(axis, self);
                }
              }
          });
